...
class DashboardBarbekoeListSectionController extends Controller
{
    /**
    ...
    {
        return view('admin.barbekoe.listsection.index', [
            'listsections' => ListSection::where("typelanding", "barbekoe")->get()
        ]);
    }
    ...
    {
        return view('admin.barbekoe.listsection.create', [
            'sections' => Section::where('withlist', 1)->where('typelanding', "barbekoe")->get(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/barbekoe/listsection')->with('success', 'Berita Baru Telah Ditambahkan');
    }
    ...
    {
        return view('admin.barbekoe.listsection.show', [
    ...
    {
        return view('admin.barbekoe.listsection.edit', [
            'listsection' => $listsection,
            'sections' => Section::where('withlist', 1)->where('typelanding', "barbekoe")->get(),
    ...
    public function update(Request $request, ListSection $listsection)
    {
        ...
        return redirect('/dashboard/barbekoe/listsection')->with('success', 'Section Baru Telah Diubah');
    }
    /**
    ...
    public function destroy(ListSection $listsection)
    {
        ...
        return redirect('/dashboard/barbekoe/listsection')->with('success', 'Section Telah Dihapus');
    }
}

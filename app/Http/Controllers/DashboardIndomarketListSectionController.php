...
class DashboardIndomarketListSectionController extends Controller
{
    /**
    ...
    {
        return view('admin.indomarket.listsection.index', [
            'listsections' => ListSection::where("typelanding", "indomarket")->get()
        ]);
    }
    ...
    {
        return view('admin.indomarket.listsection.create', [
            'sections' => Section::where('withlist', 1)->where('typelanding', "indomarket")->get(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/indomarket/listsection')->with('success', 'Berita Baru Telah Ditambahkan');
    }
    ...
    {
        return view('admin.indomarket.listsection.show', [
    ...
    {
        return view('admin.indomarket.listsection.edit', [
            'listsection' => $listsection,
            'sections' => Section::where('withlist', 1)->where('typelanding', "indomarket")->get(),
    ...
    public function update(Request $request, ListSection $listsection)
    {
        ...
        return redirect('/dashboard/indomarket/listsection')->with('success', 'Section Baru Telah Diubah');
    }
    /**
    ...
    public function destroy(ListSection $listsection)
    {
        ...
        return redirect('/dashboard/indomarket/listsection')->with('success', 'Section Telah Dihapus');
    }
}

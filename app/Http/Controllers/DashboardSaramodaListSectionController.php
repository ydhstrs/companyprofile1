...
class DashboardSaramodaListSectionController extends Controller
{
    /**
    ...
    {
        return view('admin.saramoda.listsection.index', [
            'listsections' => ListSection::where("typelanding", "saramoda")->get()
        ]);
    }
    ...
    {
        return view('admin.saramoda.listsection.create', [
            'sections' => Section::where('withlist', 1)->where('typelanding', "saramoda")->get(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/saramoda/listsection')->with('success', 'Berita Baru Telah Ditambahkan');
    }
    ...
    {
        return view('admin.saramoda.listsection.show', [
    ...
    {
        return view('admin.saramoda.listsection.edit', [
            'listsection' => $listsection,
            'sections' => Section::where('withlist', 1)->where('typelanding', "saramoda")->get(),
    ...
    public function update(Request $request, ListSection $listsection)
    {
        ...
        return redirect('/dashboard/saramoda/listsection')->with('success', 'Section Baru Telah Diubah');
    }
    /**
    ...
    public function destroy(ListSection $listsection)
    {
        ...
        return redirect('/dashboard/saramoda/listsection')->with('success', 'Section Telah Dihapus');
    }
}

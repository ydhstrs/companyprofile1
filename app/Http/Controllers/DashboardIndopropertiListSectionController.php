...
class DashboardIndopropertiListSectionController extends Controller
{
    /**
    ...
    {
        return view('admin.indoproperti.listsection.index', [
            'listsections' => ListSection::where("typelanding", "indoproperti")->get()
        ]);
    }
    ...
    {
        return view('admin.indoproperti.listsection.create', [
            'sections' => Section::where('withlist', 1)->where('typelanding', "indoproperti")->get(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/indoproperti/listsection')->with('success', 'Berita Baru Telah Ditambahkan');
    }
    ...
    {
        return view('admin.indoproperti.listsection.show', [
    ...
    {
        return view('admin.indoproperti.listsection.edit', [
            'listsection' => $listsection,
            'sections' => Section::where('withlist', 1)->where('typelanding', "indoproperti")->get(),
    ...
    public function update(Request $request, ListSection $listsection)
    {
        ...
        return redirect('/dashboard/indoproperti/listsection')->with('success', 'Section Baru Telah Diubah');
    }
    /**
    ...
    public function destroy(ListSection $listsection)
    {
        ...
        return redirect('/dashboard/indoproperti/listsection')->with('success', 'Section Telah Dihapus');
    }
}

...
class DashboardFoundationListSectionController extends Controller
{
    /**
    ...
    {
        return view('admin.foundation.listsection.index', [
            'listsections' => ListSection::where("typelanding", "foundation")->get()
        ]);
    }
    ...
    {
        return view('admin.foundation.listsection.create', [
            'sections' => Section::where('withlist', 1)->where('typelanding', "foundation")->get(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/foundation/listsection')->with('success', 'Berita Baru Telah Ditambahkan');
    }
    ...
    {
        return view('admin.foundation.listsection.show', [
    ...
    {
        return view('admin.foundation.listsection.edit', [
            'listsection' => $listsection,
            'sections' => Section::where('withlist', 1)->where('typelanding', "foundation")->get(),
    ...
    public function update(Request $request, ListSection $listsection)
    {
        ...
        return redirect('/dashboard/foundation/listsection')->with('success', 'Section Baru Telah Diubah');
    }
    /**
    ...
    public function destroy(ListSection $listsection)
    {
        ...
        return redirect('/dashboard/foundation/listsection')->with('success', 'Section Telah Dihapus');
    }
}

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <a href="/dashboard/legalin/listsection/create"
                            ...
                            @foreach ($listsections as $item)
                                <tr>
                                    ...
                                    <td class="flex flex-wrap gap-2">
                                        ...
                                        <a href="/dashboard/legalin/listsection/{{ $item->slug }}">
                                        ...
                                        <a href="/dashboard/legalin/listsection/{{ $item->slug }}/edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    <div>
                        <form action="/dashboard/legalin/listsection/{{ $item->slug }}" method="post">
                            @method('delete')
                            @csrf

            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="block w-full overflow-x-auto p-8">
                        <form method="post" action="/dashboard/strength/{{ $strength->id }}"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="title" name="title"
                                    class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg" value="{{ $strength->title }}">
                            </div>

                            <div class="mb-6">
                                @if ($strength->image)
                                    <img src="{{ asset('/storage/' . $strength->image) }}" class="img-preview w-56">
                                @else
                                    <img class="img-preview w-56">
                                @endif
                                <input type="hidden" name="oldImage" value="{{ $strength->image }}">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="isi" name="isi" class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg" > {{ $strength->isi }}</textarea>
                            </div>

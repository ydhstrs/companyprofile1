            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="block w-full overflow-x-auto p-8">
                        <form method="post" action="/dashboard/strength" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg "" name="isi" value="{{ old('isi') }}"> </textarea>
                            </div>

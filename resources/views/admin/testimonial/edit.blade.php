            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="block w-full overflow-x-auto p-8">
                        <form method="post" action="/dashboard/testimonial/{{ $testimonial->id }}"
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" id="name" name="name"
                                    class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg "value="{{ $testimonial->name }}">
                            </div>
                            <div class="mb-6">
                                <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Job</label>
                            ...
                            <div class="mb-6">
                                @if ($testimonial->image)
                                    <img src="{{ asset('/storage/' . $testimonial->image) }}" class="img-preview w-56">
                                @else
                            ...
                            <div class="mb-6">
                                ...
                                <textarea type="text" id="isi" name="isi"
                                    class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg " placeholder="" required>{{ $testimonial->isi }} </textarea>
                            </div>
                    </div>

                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="'/dashboard/legalin/section'">
                                        {{ __('Section') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="'/dashboard/legalin/listsection'">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="'/dashboard/indoproperti/section'">
                                        {{ __('Section') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="'/dashboard/indoproperti/listsection'">
                                        {{ __('List Section') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-slot>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown width="48">
                            <x-slot name="trigger">
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="'/dashboard/saramoda/section'">
                                        {{ __('Section') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="'/dashboard/saramoda/listsection'">
                                        {{ __('List Section') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-slot>

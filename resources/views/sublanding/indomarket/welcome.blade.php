    ...
    <header id="sections1" class=" text-center md:pt-36 lg:text-left 2xl:h-full lg:min-h-full  pb-6">
        ...
        <div class="">
            <div class=" mx-auto w-auto">
                <img class="h-[700px] w-full object-cover pt-10" src="{{ asset('/storage/' . $sections1->image1) }}">
            </div>
        ...
        <div class="mx-4 relative flex  pt-12 items-center pb-12">
            <span class="items-end  h-0.5 flex-grow bg-gray-400 lg:w-1/3"></span>
        </div>
        ...
        <div class=" bg-black">
                <div
                    ...
                    <div class="col-span-1 m-auto">
                        <h1 class="text-white md:mr-32">Contact Us
                        </h1>

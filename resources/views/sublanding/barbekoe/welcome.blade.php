...
@section('contents')
  ...
  ">
                    <div class="h-10 self-center mx-4">
                        <img class="h-10 self-center" src="{{ asset('/storage/' . $sections1->image1) }}" />
                    </div>
    ...
    <header id="" class=" text-center md:pt-36 lg:text-left pb-10">
        ...
        <div class="container">
            <div class="col-span-1 mx-auto  w-auto pt-10">
    ...
    <section id="sections2" class=" bg-gray-100 rounded-lg shadow-xl my-4 lg:mx-4">
        <div class="lg:grid lg:grid-cols-5 lg:gap-4 sm:flex md:flex-row sm:mx-auto  container py-6">
            ...
            <div class="col-span-1 bg-[url('/public/images/barbecuan.png')] bg-cover bg-center py-24">
                ...
                <div class="pt-8 pb-6">
                    <a href="#" target="blank"
                        class="text-sm bg-white text-gray-700 py-3 px-6 rounded-xl hover:shadow-md hover:opacity-80 transition duration-500 ease-in-out shadow-xl mx-10">
                        Purchase in App</a>
                </div>
            </div>
